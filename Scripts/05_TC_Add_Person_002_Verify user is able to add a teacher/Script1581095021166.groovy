...
'Clicked on Add Teacher button.'
WebUI.click(findTestObject('Object Repository/Page_Studio Helper  Users/a_Add Teacher'))

'Set value for first name'
WebUI.setText(findTestObject('Page_Studio Helper  Users/input_First Name_dataUserfirst_name'), 'Teacher')
...
'"Teacher automation test\'s profile has been saved" observed'
