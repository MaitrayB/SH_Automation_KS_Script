...
WebUI.click(findTestObject('Page_Studio Helper  Users/a_Add Student'))

'Set value for first name'
WebUI.setText(findTestObject('Page_Studio Helper  Users/input_First Name_dataUserfirst_name'), 'Student')
...
'"Student automation test\'s profile has been saved" observed'
