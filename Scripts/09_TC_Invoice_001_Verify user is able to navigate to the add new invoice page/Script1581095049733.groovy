...
WebUI.mouseOver(findTestObject('Page_Studio Helper  Users/a_Money'))

'Mouse Over on Invoicing option'
WebUI.mouseOver(findTestObject('Page_Studio Helper  Users/a_Invoicing'))

'Clicked on Payment option'
WebUI.mouseOver(findTestObject('Page_Studio Helper  Users/a_Payments'))

'click on receive payment option'
WebUI.click(findTestObject('Page_Studio Helper  Users/a_Receive Payment'))

'Verified that payment information page is opened'
WebUI.verifyElementPresent(findTestObject('Page_Studio Helper  Payments/h1_Payment Information'), 0)
