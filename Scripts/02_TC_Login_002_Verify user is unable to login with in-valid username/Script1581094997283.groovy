...
WebUI.setText(findTestObject('Page_Studio Helper  Users/input_Login to Studio Helper_dataUserusername'), 'harsh.french123@gmail.com')

'Enter password'
WebUI.setEncryptedText(findTestObject('Page_Studio Helper  Users/input_Login to Studio Helper_dataUserpassword'), 'iGDxf8hSRT4=')
